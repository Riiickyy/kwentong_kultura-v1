...
/// ActionItem represents a user action that can be undone/redone.
/// - type: 'draw', 'erase', 'clear'
/// - stroke: for 'draw' (List<DrawingArea?> including trailing null)
/// - removed: for 'erase' (List of {'index': int, 'point': DrawingArea?})
/// - snapshot: for 'clear' (full List<DrawingArea?> before clearing)
class ActionItem {
  final String type;

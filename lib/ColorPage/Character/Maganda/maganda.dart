...
import 'package:kwentong_kultura/ColorPage/Character/Maganda/magandacolorclass.dart';
import 'package:kwentong_kultura/Styles/styles.dart';

class Maganda extends StatefulWidget {
  const Maganda({super.key});

  @override
  State<Maganda> createState() => _MagandaState();
}
...
class _MagandaState extends State<Maganda> {
  ...
  Future<void> loadImage() async {
    final ByteData data = await rootBundle.load(
      'assets/images/Color/Character/Maganda.png',

...
import 'package:kwentong_kultura/ColorPage/Character/Unggoy/unggoycolorclass.dart';
import 'package:kwentong_kultura/Styles/styles.dart';

class Unggoy extends StatefulWidget {
  const Unggoy({super.key});

  @override
  State<Unggoy> createState() => _UnggoyState();
}
...
class _UnggoyState extends State<Unggoy> {
  ...
  Future<void> loadImage() async {
    final ByteData data = await rootBundle.load(
      'assets/images/Color/Character/Unggoy.png',

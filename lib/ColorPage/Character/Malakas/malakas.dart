...
import 'package:kwentong_kultura/ColorPage/Character/Malakas/malakascolorclass.dart';

class Malakas extends StatefulWidget {
  const Malakas({super.key});

  @override
  State<Malakas> createState() => _MalakasState();
}
...
class _MalakasState extends State<Malakas> {
  ...
  Future<void> loadImage() async {
    final ByteData data = await rootBundle.load(
      'assets/images/Color/Character/Malakas.png',

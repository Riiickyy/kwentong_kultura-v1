...
import 'package:kwentong_kultura/ColorPage/Character/Pinya/pinyacolorclass.dart';
...
class Pinya extends StatefulWidget {
  ...
  @override
  State<Pinya> createState() => _PinyaState();
}
...
class _PinyaState extends State<Pinya> {
  ...
  Future<void> loadImage() async {
    final ByteData data = await rootBundle.load(
      'assets/images/Color/Character/Pinya.png',

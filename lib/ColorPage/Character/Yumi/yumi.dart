...
import 'package:kwentong_kultura/ColorPage/Character/Yumi/yumicolorclass.dart';
import 'package:kwentong_kultura/Styles/styles.dart';

class Yumi extends StatefulWidget {
  const Yumi({super.key});

  @override
  State<Yumi> createState() => _YumiState();
}
...
class _YumiState extends State<Yumi> {
  ...
  Future<void> loadImage() async {
    final ByteData data = await rootBundle.load(
      'assets/images/Color/Character/Yumi.png',

...
class Tamscene1 extends StatefulWidget {
  const Tamscene1({super.key});

  @override
  State<Tamscene1> createState() => _Tamscene1State();
}

class _Tamscene1State extends State<Tamscene1> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Tipaklong at Langgam/SC2.png',

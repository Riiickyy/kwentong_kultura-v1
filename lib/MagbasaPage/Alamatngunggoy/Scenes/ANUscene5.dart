...
class Anuscene5 extends StatefulWidget {
  const Anuscene5({super.key});

  @override
  State<Anuscene5> createState() => _Anuscene5State();
}

class _Anuscene5State extends State<Anuscene5> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Alamat ng unggoy/SC6.png',

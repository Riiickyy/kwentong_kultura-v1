...
class Mamscene2 extends StatefulWidget {
  const Mamscene2({super.key});

  @override
  State<Mamscene2> createState() => _Mamscene2State();
}

class _Mamscene2State extends State<Mamscene2> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Malakas at Maganda/SC3.png',

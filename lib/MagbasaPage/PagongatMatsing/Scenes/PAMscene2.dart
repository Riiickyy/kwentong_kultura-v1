...
class Pamscene2 extends StatefulWidget {
  const Pamscene2({super.key});

  @override
  State<Pamscene2> createState() => _Pamscene2State();
}

class _Pamscene2State extends State<Pamscene2> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Pagong at Matsing/SC3.png',

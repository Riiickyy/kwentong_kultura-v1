...
class Pamscene6 extends StatefulWidget {
  const Pamscene6({super.key});

  @override
  State<Pamscene6> createState() => _Pamscene6State();
}

class _Pamscene6State extends State<Pamscene6> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Pagong at Matsing/SC7.png',

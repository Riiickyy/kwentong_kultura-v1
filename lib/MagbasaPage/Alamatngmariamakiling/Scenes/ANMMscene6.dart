...
import 'package:kwentong_kultura/MagbasaPage/Alamatngmariamakiling/Scenes/ANMMscene5.dart';
import 'package:kwentong_kultura/MagbasaPage/Alamatngmariamakiling/Scenes/ANMMscene7.dart';
import 'package:kwentong_kultura/Pages/taramagbasa.dart';
import 'package:kwentong_kultura/Styles/styles.dart';

class Anmmscene6 extends StatefulWidget {
  const Anmmscene6({super.key});

  @override
  State<Anmmscene6> createState() => _Anmmscene6State();
}

class _Anmmscene6State extends State<Anmmscene6> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Maria Makiling/SC7.png',

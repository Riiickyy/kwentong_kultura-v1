...
import 'package:kwentong_kultura/MagbasaPage/Alamatngmariamakiling/Scenes/ANMMscene3.dart';
import 'package:kwentong_kultura/MagbasaPage/Alamatngmariamakiling/Scenes/ANMMscene5.dart';
import 'package:kwentong_kultura/Pages/taramagbasa.dart';
import 'package:kwentong_kultura/Styles/styles.dart';

class Anmmscene4 extends StatefulWidget {
  const Anmmscene4({super.key});

  @override
  State<Anmmscene4> createState() => _Anmmscene4State();
}

class _Anmmscene4State extends State<Anmmscene4> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Maria Makiling/SC5.png',

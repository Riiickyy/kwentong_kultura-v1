...
class Anmmscene7 extends StatefulWidget {
  const Anmmscene7({super.key});

  @override
  State<Anmmscene7> createState() => _Anmmscene7State();
}

class _Anmmscene7State extends State<Anmmscene7> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Maria Makiling/SC8.png',

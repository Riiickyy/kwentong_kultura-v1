...
class Anmmscene2 extends StatefulWidget {
  const Anmmscene2({super.key});

  @override
  State<Anmmscene2> createState() => _Anmmscene2State();
}

class _Anmmscene2State extends State<Anmmscene2> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Maria Makiling/SC3.png',

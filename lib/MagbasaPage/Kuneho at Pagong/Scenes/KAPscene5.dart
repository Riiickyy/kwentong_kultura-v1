...
class Kapscene5 extends StatefulWidget {
  const Kapscene5({super.key});

  @override
  State<Kapscene5> createState() => _Kapscene5State();
}

class _Kapscene5State extends State<Kapscene5> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Pagong at Kuneho/SC6.png',

...
class AlamatngniyogBasa extends StatefulWidget {
  const AlamatngniyogBasa({super.key});

  @override
  State<AlamatngniyogBasa> createState() => _AlamatngniyogBasaState();
}

class _AlamatngniyogBasaState extends State<AlamatngniyogBasa> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Alamat ng Niyog/SC1.png',

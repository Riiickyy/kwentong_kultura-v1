...
class Annscene1 extends StatefulWidget {
  const Annscene1({super.key});

  @override
  State<Annscene1> createState() => _Annscene1State();
}

class _Annscene1State extends State<Annscene1> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Alamat ng Niyog/SC2.png',

...
import 'package:kwentong_kultura/MagbasaPage/Alamatngniyog/Scenes/ANNscene7.dart';
import 'package:kwentong_kultura/Pages/taramagbasa.dart';
import 'package:kwentong_kultura/Styles/styles.dart';

class Annscene6 extends StatefulWidget {
  const Annscene6({super.key});

  @override
  State<Annscene6> createState() => _Annscene6State();
}

class _Annscene6State extends State<Annscene6> {
  @override
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                            'assets/images/Read Scenes/Alamat ng Niyog/SC7.png',
